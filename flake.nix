        ...
        in
        {
          "${hostname}" = {
            ...
            profiles = {
              system = {
                user = "root";
                path = inputs.deploy-rs.lib."${p.system}".activate.nixos self.nixosConfigurations."${p.hostname}";
              };
            };
          };
        };
          ...
          rec {
            ...
            devShells = with pkgsToBuildLocalPackages; {
              ...
              sops = mkShell {
                ...
                nativeBuildInputs = [ (callPackage inputs.sops-nix { }).sops-import-keys-hook ];
                shellHook = ''
                  alias s="sops"
                '';
              };
