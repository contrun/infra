# https://github.com/myNova/nixos-configs/blob/507583b68c383dd6350b06bcde38962fb9eb5575/modules/netns-wireguard.nix
# From:
      ...
      forwardServices = builtins.listToAttrs (map (port: rec {
        ...
        value = {
          ...
          serviceConfig = {
            ...
            PrivateNetwork = true;
            ExecStart =
              "${pkgs.systemd}/lib/systemd/systemd-socket-proxyd 127.0.0.1:${
                toString port
              }";
          };
        };
